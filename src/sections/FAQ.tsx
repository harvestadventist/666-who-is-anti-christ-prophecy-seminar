...
const faqs = [
  {
    question: '誰可以參加這個講座？',
    answer:
      '這個講座歡迎所有信仰和背景的人參加。無論您是剛開始信仰之旅，還是已經研究聖經預言數十年，這個講座都將加強、激勵和教育您的信仰。歡迎所有人參加！',
  },
  {
    question: '為什麼要研究啟示錄？',
    answer:
  ...
  },
  {
    question: '我們的信仰是什麼？',
    answer:
      '我們相信聖經是神的話語，是信仰和實踐的權威。我們的講座基於聖經的教導，旨在幫助人們更親近基督並理解祂為我們預備的未來。',
  },
  {
    question: '這個講座真的是免費的嗎？',
    answer:
      '是的！這個講座完全免費。我們相信每個人都應該有機會了解聖經預言，因此我們提供免費入場、免費材料，甚至還有免費禮物給所有參與者！',
  },
];
