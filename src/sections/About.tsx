    ...
    >
      <div className="content-container flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        <div ref={textRef} className="w-full lg:w-[55%]">
          ...
          >
            在這個充滿活力的研討會中，您將發現關於聖經預言和啟示錄的內容，遠超您的想像。啟示錄充滿了神秘的徵兆、奇異的獸和令人困惑的數字，但這一切究竟意味著什麼？是否有鑰匙能為我們今天解開啟示錄的奧秘？有了這些鑰匙，我們能夠理解啟示錄嗎？我們的世界將走向何方？在這些末世預言中是否有盼望？我們能從這本書的頁面中為今天的生活找到平安嗎？發現當您理解這本常被誤解的聖經書卷時，可以找到的真理和盼望。不要錯過這個激動人心的機會——今天就報名參加這個免費研討會！
          </p>
