...
const testimonials = [
  {
    ...
    quote:
      '我當時迫切地尋找平安。我知道答案在聖經裡，但我從未讀過。當我參加這個研討會時，感覺就像一塊大石頭從我背上移開了。這對我的心產生了很大的改變。',
    name: 'Kimberly',
  },
  {
    image: '/images/testimonial-2.jpg',
    quote:
      '這個研討會回答了我所有的問題，甚至還有我根本不知道自己有的問題。我現在有盼望了，因為我知道故事的結局。',
    name: 'Cicille',
  },
  {
    image: '/images/testimonial-3.jpg',
    quote:
      '一個非常專業的演講。這個研討會將古老的聖經真理變得與我今天的生活息息相關。耶穌對我來說變得更真實了。',
    name: 'Joshua',
  },
];
